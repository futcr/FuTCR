...
class MultiScaleMaskedTransformerDecoder(nn.Module):
    ...
    def forward(self, x, mask_features, mask = None):
        ...
        enc_outputs_class_unselected, enc_outputs_outputs_mask, attn_mask = self.forward_prediction_heads(
            feats, mask_features, attn_mask_target_size=size_list[0]) 
        ...
        tgt_undetach = torch.gather(feats.permute(1, 0, 2), 1,
        ...
        for i in range(self.num_layers):
            if True:
                ...
                reference_points = refpoint_embed.transpose(0, 1)
                # reference_points_input = reference_points[:, :, None] \
                #                              * torch.cat([valid_ratios, valid_ratios], -1)[None, :]  # nq, bs, nlevel, 4
                # query_sine_embed = self._gen_sineembed_for_position(reference_points_input[:, :, 0, :]) # nq, bs, 256*2
                query_sine_embed = self._gen_sineembed_for_position(reference_points) # nq, bs, 256*2
